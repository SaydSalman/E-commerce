      ...
      {cart?.length>0?
        ...
        <div className="col-lg-4">
          <div className="d-flex flex-column border rounded p-4">
            <h5 style={{height:'30px'}}>Total Product: <span className='fw-bolder'>3</span></h5>
            <h4 style={{height:'30px'}}>Total Amount: <span className='text-danger fw-bolder'>$ 560</span></h4>
            <hr />
